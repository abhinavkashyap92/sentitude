...
class TestGMM(object):
	...
	def __init__(self,number_of_samples):
		...
		self.happy_features =  self.get_audio_frames("../../../Dataset/Happiness/HappinessAudios")
		self.sadness_features = self.get_audio_frames("../../../Dataset/Sadness/SadnessAudios")
	...
	def test(self):
		...
		for i in xrange(150,200):
			extractor = FeatureExtractor("../../../Dataset/Sadness/SadnessAudios/"+str(i)+".wav")
