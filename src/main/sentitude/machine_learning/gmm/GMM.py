...
class GMM():
    ...
    def initialisation(self):
        ...
        #0th element of grouped data represents the 0th cluster and consists of the frames belonging to that cluster
        ...
        for everyMatrix in group_data:        
        	...
        	gaussian = MultiVariateGaussian(mean_vector,covariance_matrix,dimension)
