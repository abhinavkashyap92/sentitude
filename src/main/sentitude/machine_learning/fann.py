...
def main():
    ...
    # train_data_file = open("training_data.data", "w")
    # train_data_file.writelines("194226 " + str(26) + " 1\n")
    ...
    #
    # ann.train_on_file("training_data.data", max_iterations, iterations_between_reports, desired_error)
    #
    # ann.save("fann_try_15000.net")
    # Create neural network from file
    ann = libfann.neural_net()
    ann.create_from_file("fann_try_15000.net")  # A trained network ll be loaded
